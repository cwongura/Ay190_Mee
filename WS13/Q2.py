# -*- coding: utf-8 -*-
"""
Created on Tue Feb 25 00:49:24 2014

For Ay190 - Computational Astrophysics - WS13 - Q2
...
final_data_file = "final_positions_RK4.asc"
...
for it in range(0, Nsteps):
    ...
    if it % max(1,Nsteps/100) == 0:
      print "it = %d, time = %g years, dist = %g cm" % \
            (it, time / seconds_per_year, dist)
      plt.clf()
      fig = plt.gcf()
      ax = mpl3d.Axes3D(fig)
