...
Creates figure showing maximum eccentricity achieved from several initial
inclination angle.
...
##################################################################
# ***************************************************************#
# Taking long time to run this code because I use large Nsteps
# ***************************************************************#
##################################################################
import numpy as np
...
theta = np.array([0.,5.,10.,15.,20.,25.,30.,35.,40.,45.,50.,
