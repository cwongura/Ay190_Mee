# -*- coding: utf-8 -*-
"""
Created on Thu Jan 16 02:42:42 2014
...
pl.legend( (p2,p3), ("$Linear$","$Quadratic$"), 
           loc=(0.6,0.15), frameon=False )

pl.show()
pl.savefig("DiffInter.pdf")